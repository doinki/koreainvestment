# [퇴직연금 예수금조회[v1\_국내주식-035]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/trading/pension/inquire-deposit)
...
| output.nxdy_excc_amt    | 익일정산액     | String | Y        | 19     |             |
| output.nxdy_sttl_amt    | 익일결제금액   | String | Y        | 19     |             |
| output.nx2_day_sttl_amt | 2익일결제금액  | String | Y        | 19     |             |
