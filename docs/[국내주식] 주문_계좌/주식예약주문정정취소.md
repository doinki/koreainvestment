# [주식예약주문정정취소[v1\_국내주식-018,019]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/trading/order-resv-rvsecncl)
...
- 모의 DOMAIN: 모의투자 미지원
- 실전 TR ID: (예약취소) CTSC0009U (예약정정) CTSC0013U
- 모의 TR ID: 모의투자 미지원
...
| output              | 응답상세       | Array  | Y        |        |                             |
| output.nrml_prcs_yn | 정상처리여부   | String | Y        | 1      |                             |
