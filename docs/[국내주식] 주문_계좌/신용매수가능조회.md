# [신용매수가능조회[v1\_국내주식-042]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/trading/inquire-credit-psamount)
...
| output.ord_psbl_sbst          | 주문가능대용         | String | Y        | 19     |                             |
| output.ruse_psbl_amt          | 재사용가능금액       | String | Y        | 19     |                             |
| output.fund_rpch_chgs         | 펀드환매대금         | String | Y        | 19     |                             |
| output.psbl_qty_calc_unpr     | 가능수량계산단가     | String | Y        | 19     |                             |
| output.nrcvb_buy_amt          | 미수없는매수금액     | String | Y        | 19     |                             |
| output.nrcvb_buy_qty          | 미수없는매수수량     | String | Y        | 10     |                             |
| output.max_buy_amt            | 최대매수금액         | String | Y        | 19     |                             |
| output.max_buy_qty            | 최대매수수량         | String | Y        | 10     |                             |
| output.cma_evlu_amt           | CMA평가금액          | String | Y        | 19     |                             |
| output.ovrs_re_use_amt_wcrc   | 해외재사용금액원화   | String | Y        | 19     |                             |
| output.ord_psbl_frcr_amt_wcrc | 주문가능외화금액원화 | String | Y        | 19     |                             |
