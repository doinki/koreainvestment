# [국내선물 기초자산 시세[국내선물-021]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-futureoption/v1/quotations/display-board-top)
...
| output1.unas_prpr           | 기초자산 현재가         | String       | Y        | 112    |             |
| output1.unas_prdy_vrss      | 기초자산 전일 대비      | String       | Y        | 112    |             |
| output1.unas_prdy_vrss_sign | 기초자산 전일 대비 부호 | String       | Y        | 1      |             |
| output1.unas_prdy_ctrt      | 기초자산 전일 대비율    | String       | Y        | 82     |             |
| output1.unas_acml_vol       | 기초자산 누적 거래량    | String       | Y        | 18     |             |
...
| output2.hts_rmnn_dynu       | HTS 잔존 일수           | String       | Y        | 5      |             |
