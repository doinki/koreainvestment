# [국내옵션전광판\_옵션월물리스트[국내선물-020]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-futureoption/v1/quotations/display-board-option-list)
...
- 모의 DOMAIN: 모의투자 미지원
- 실전 TR ID: FHPIO056104C0
- 모의 TR ID: 모의투자 미지원

## 개요

국내업종 국내옵션전광판\_옵션월물리스트 API입니다.
...
| output1.mtrt_yymm_code | 만기 년월 코드 | String       | Y        | 6      |             |
| output1.mtrt_yymm      | 만기 년월      | String       | Y        | 6      |             |
