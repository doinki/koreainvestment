# [국내주식 예상체결 전체지수[국내주식-122]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/quotations/exp-total-index)
...
| output2.ascn_issu_cnt       | 상승 종목 수          | String       | Y        | 7      |             |
| output2.stnr_issu_cnt       | 보합 종목 수          | String       | Y        | 7      |             |
| output2.down_issu_cnt       | 하락 종목 수          | String       | Y        | 7      |             |
