# [국내업종 시간별지수(초)[국내주식-064]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/quotations/inquire-index-tickprice)
...
| output.stck_cntg_hour      | 주식 체결 시간        | String       | Y        | 6      |             |
