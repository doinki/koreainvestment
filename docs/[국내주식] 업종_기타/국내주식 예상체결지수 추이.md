# [국내주식 예상체결지수 추이[국내주식-121]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/quotations/exp-index-trend)
...
| output.stck_cntg_hour      | 주식 단축 종목코드 | String       | Y        | 6      |             |
| output.bstp_nmix_prpr      | HTS 한글 종목명    | String       | Y        | 112    |             |
| output.prdy_vrss_sign      | 주식 현재가        | String       | Y        | 1      |             |
| output.bstp_nmix_prdy_vrss | 전일 대비          | String       | Y        | 112    |             |
| output.prdy_ctrt           | 전일 대비 부호     | String       | Y        | 82     |             |
| output.acml_vol            | 전일 대비율        | String       | Y        | 18     |             |
| output.acml_tr_pbmn        | 기준가 대비 현재가 | String       | Y        | 18     |             |
