# [국내주식 예상체결가 추이[국내주식-118]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/quotations/exp-price-trend)
...
| output1.antc_cnpr           | 예상 체결가           | String       | Y        | 10     |             |
| output1.antc_cntg_vrss_sign | 예상 체결 대비 부호   | String       | Y        | 1      |             |
| output1.antc_cntg_vrss      | 예상 체결 대비        | String       | Y        | 10     |             |
| output1.antc_cntg_prdy_ctrt | 예상 체결 전일 대비율 | String       | Y        | 82     |             |
| output1.antc_vol            | 예상 거래량           | String       | Y        | 18     |             |
| output1.antc_tr_pbmn        | 예상 거래대금         | String       | Y        | 19     |             |
