# [종목조건검색 목록조회[국내주식-038]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/quotations/psearch-title)
...
| output2.user_id      | HTS ID         | String       | Y        | 40     |                                                                             |
| output2.seq          | 조건키값       | String       | Y        | 10     | 해당 값을 종목조건검색조회 API의 input으로 사용 (0번부터 시작)              |
| output2.grp_nm       | 그룹명         | String       | Y        | 40     | HTS(eFriend Plus) [0110] "사용자조건검색"화면을 통해 등록한 사용자조건 그룹 |
| output2.condition_nm | 조건명         | String       | Y        | 40     | 등록한 사용자 조건명                                                        |
