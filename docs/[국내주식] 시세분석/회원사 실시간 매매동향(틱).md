# [회원사 실시간 매매동향(틱) [국내주식-163]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/quotations/frgnmem-trade-trend)
...
| output1.total_seln_qty     | 총매도수량           | String       | Y        | 18     |             |
| output1.total_shnu_qty     | 총매수2수량          | String       | Y        | 18     |             |
| output2                    | 응답상세             | Object Array | Y        |        | array       |
| output2.bsop_hour          | 영업시간             | String       | Y        | 6      |             |
| output2.mbcr_name          | 회원사명             | String       | Y        | 50     |             |
| output2.hts_kor_isnm       | HTS한글종목명        | String       | Y        | 40     |             |
...
| output2.acml_ntby_qty      | 누적순매수수량       | String       | Y        | 18     |             |
| output2.glob_ntby_qty      | 외국계순매수수량     | String       | Y        | 12     |             |
| output2.frgn_ntby_qty_icdc | 외국인순매수수량증감 | String       | Y        | 10     |             |
