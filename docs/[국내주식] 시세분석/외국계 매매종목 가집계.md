# [외국계 매매종목 가집계 [국내주식-161]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/quotations/frgnmem-trade-estimate)
...
| output.glob_ntsl_qty       | 외국계순매도수량  | String       | Y        | 12     |             |
...
| output.glob_total_seln_qty | 외국계총매도수량  | String       | Y        | 18     |             |
| output.glob_total_shnu_qty | 외국계총매수2수량 | String       | Y        | 18     |             |
