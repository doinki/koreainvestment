# [주식현재가 회원사 종목매매동향 [국내주식-197]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/quotations/inquire-member-daily)
...
| output.total_seln_qty | 총매도수량     | String       | Y        | 18     |             |
| output.total_shnu_qty | 총매수2수량    | String       | Y        | 18     |             |
| output.ntby_qty       | 순매수수량     | String       | Y        | 18     |             |
