# [국내주식 장마감 예상체결가[국내주식-120]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/quotations/exp-closing-price)
...
| output1.sdpr_vrss_prpr      | 기준가 대비 현재가      | String       | Y        | 10     |             |
| output1.sdpr_vrss_prpr_rate | 기준가 대비 현재가 비율 | String       | Y        | 84     |             |
| output1.cntg_vol            | 체결 거래량             | String       | Y        | 18     |             |
