# [관심종목 그룹조회 [국내주식-204]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/quotations/intstock-grouplist)
...
| output2.date           | 일자           | String | Y        | 8      |             |
| output2.trnm_hour      | 전송 시간      | String | Y        | 6      |             |
| output2.data_rank      | 데이터 순위    | String | Y        | 10     |             |
| output2.inter_grp_code | 관심 그룹 코드 | String | Y        | 3      |             |
| output2.inter_grp_name | 관심 그룹 명   | String | Y        | 40     |             |
| output2.ask_cnt        | 요청 개수      | String | Y        | 4      |             |
