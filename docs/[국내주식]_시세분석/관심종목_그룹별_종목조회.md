# [관심종목 그룹별 종목조회 [국내주식-203]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/quotations/intstock-stocklist-by-group)
...
| output1.data_rank         | 데이터 순위        | String       | Y        | 10     |             |
| output1.inter_grp_name    | 관심 그룹 명       | String       | Y        | 40     |             |
| output2                   | 응답상세           | Object Array | Y        |        | array       |
| output2.fid_mrkt_cls_code | FID 시장 구분 코드 | String       | Y        | 2      |             |
| output2.data_rank         | 데이터 순위        | String       | Y        | 10     |             |
| output2.exch_code         | 거래소코드         | String       | Y        | 4      |             |
| output2.jong_code         | 종목코드           | String       | Y        | 16     |             |
| output2.color_code        | 생상 코드          | String       | Y        | 8      |             |
| output2.memo              | 메모               | String       | Y        | 128    |             |
| output2.hts_kor_isnm      | HTS 한글 종목명    | String       | Y        | 40     |             |
| output2.fxdt_ntby_qty     | 기준일 순매수 수량 | String       | Y        | 12     |             |
| output2.cntg_unpr         | 체결단가           | String       | Y        | 11     |             |
| output2.cntg_cls_code     | 체결 구분 코드     | String       | Y        | 1      |             |
