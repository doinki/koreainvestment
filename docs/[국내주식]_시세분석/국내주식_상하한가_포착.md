# [국내주식 상하한가 포착 [국내주식-190]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/quotations/capture-uplowprice)
...
| output.mksc_shrn_iscd     | 유가증권단축종목코드 | String       | Y        | 9      |             |
...
| output.askp_rsqn1         | 매도호가잔량1        | String       | Y        | 12     |             |
| output.bidp_rsqn1         | 매수호가잔량1        | String       | Y        | 12     |             |
| output.prdy_vol           | 전일거래량           | String       | Y        | 18     |             |
| output.seln_cnqn          | 매도체결량           | String       | Y        | 18     |             |
| output.shnu_cnqn          | 매수2체결량          | String       | Y        | 18     |             |
| output.stck_llam          | 주식하한가           | String       | Y        | 10     |             |
| output.stck_mxpr          | 주식상한가           | String       | Y        | 10     |             |
| output.prdy_vrss_vol_rate | 전일대비거래량비율   | String       | Y        | 84     |             |
