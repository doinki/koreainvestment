# [종목별 외국계 순매수추이 [국내주식-164]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/quotations/frgnmem-pchs-trend)
...
| output.bsop_hour          | 영업시간             | String       | Y        | 6      |             |
...
| output.frgn_seln_vol      | 외국인매도거래량     | String       | Y        | 18     |             |
| output.frgn_shnu_vol      | 외국인매수2거래량    | String       | Y        | 18     |             |
| output.glob_ntby_qty      | 외국계순매수수량     | String       | Y        | 12     |             |
| output.frgn_ntby_qty_icdc | 외국인순매수수량증감 | String       | Y        | 10     |             |
