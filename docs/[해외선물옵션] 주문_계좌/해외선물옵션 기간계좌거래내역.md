# [해외선물옵션 기간계좌거래내역[해외선물-014]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/overseas-futureoption/v1/trading/inquire-period-trans)
...
| output.fm_ldgr_inog_seq  | FM원장출납순번   | String       | Y        | 10     |             |
| output.acnt_tr_type_name | 계좌거래유형명   | String       | Y        | 60     |             |
| output.crcy_cd           | 통화코드         | String       | Y        | 3      |             |
| output.tr_itm_name       | 거래항목명       | String       | Y        | 60     |             |
| output.fm_iofw_amt       | FM입출금액       | String       | Y        | 20     |             |
| output.fm_fee            | FM수수료         | String       | Y        | 20     |             |
| output.fm_tax_amt        | FM세금금액       | String       | Y        | 20     |             |
| output.fm_sttl_amt       | FM결제금액       | String       | Y        | 20     |             |
| output.fm_bf_dncl_amt    | FM이전예수금액   | String       | Y        | 20     |             |
| output.fm_dncl_amt       | FM예수금액       | String       | Y        | 20     |             |
| output.fm_rcvb_occr_amt  | FM미수발생금액   | String       | Y        | 20     |             |
| output.fm_rcvb_pybk_amt  | FM미수변제금액   | String       | Y        | 20     |             |
| output.ovdu_int_pybk_amt | 연체이자변제금액 | String       | Y        | 20     |             |
| output.rmks_text         | 비고내용         | String       | Y        | 500    |             |
