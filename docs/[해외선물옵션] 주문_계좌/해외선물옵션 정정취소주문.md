# [해외선물옵션 정정취소주문 [v1\_해외선물-002, 003]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/overseas-futureoption/v1/trading/order-rvsecncl)
...
- 모의 DOMAIN: 모의투자 미지원
- 실전 TR ID: (정정) OTFM3002U (취소) OTFM3003U
- 모의 TR ID: 모의투자 미지원
...
| tr_id          | 거래ID            | String | Y        | 13     | [실전투자] OTFM3002U : 해외선물옵션주문정정 OTFM3003U : 해외선물옵션주문취소                                                                                                                                                                                                                                                                                                           |
...
| output        |                | Object | N        |        |                                                                                                               |
| output.ORD_DT | 주문일자       | String | N        | 8      | YYYYMMDD(ex. 20230811)                                                                                        |
