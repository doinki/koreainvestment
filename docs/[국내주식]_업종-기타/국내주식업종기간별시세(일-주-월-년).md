# [국내주식업종기간별시세(일/주/월/년)[v1\_국내주식-021]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/quotations/inquire-daily-indexchartprice)
...
- 실전 TR ID: FHKUP03500100
- 모의 TR ID: FHKUP03500100
...
| output2.mod_yn              | 변경 여부             | String       | Y        | 1      |             |
