# [금리 종합(국내채권/금리) [국내주식-155]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/quotations/comp-interest)
...
| output1.bcdt_code           | 자료코드           | String       | Y        | 5      |             |
| output1.hts_kor_isnm        | HTS한글종목명      | String       | Y        | 40     |             |
| output1.bond_mnrt_prpr      | 채권금리현재가     | String       | Y        | 114    |             |
| output1.prdy_vrss_sign      | 전일대비부호       | String       | Y        | 1      |             |
| output1.bond_mnrt_prdy_vrss | 채권금리전일대비   | String       | Y        | 114    |             |
| output1.prdy_ctrt           | 전일대비율         | String       | Y        | 82     |             |
| output1.stck_bsop_date      | 주식영업일자       | String       | Y        | 8      |             |
| output2                     | 응답상세           | Object Array | Y        |        | array       |
| output2.bcdt_code           | 자료코드           | String       | Y        | 5      |             |
| output2.hts_kor_isnm        | HTS한글종목명      | String       | Y        | 40     |             |
| output2.bond_mnrt_prpr      | 채권금리현재가     | String       | Y        | 114    |             |
| output2.prdy_vrss_sign      | 전일대비부호       | String       | Y        | 1      |             |
| output2.bond_mnrt_prdy_vrss | 채권금리전일대비   | String       | Y        | 114    |             |
| output2.bstp_nmix_prdy_ctrt | 업종지수전일대비율 | String       | Y        | 82     |             |
