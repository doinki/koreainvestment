...
| output1.rsym | 실시간종목코드 | String       | Y        | 16     |             |
| output1.zdiv | 소수점자리수   | String       | Y        | 1      |             |
| output1.stim | 장시작현지시간 | String       | Y        | 6      |             |
| output1.etim | 장종료현지시간 | String       | Y        | 6      |             |
| output1.sktm | 장시작한국시간 | String       | Y        | 6      |             |
| output1.ektm | 장종료한국시간 | String       | Y        | 6      |             |
| output1.next | 다음가능여부   | String       | Y        | 1      |             |
| output1.more | 추가데이타여부 | String       | Y        | 1      |             |
| output1.nrec | 레코드갯수     | String       | Y        | 4      |             |
| output2      | 응답상세2      | Object       | Y        |        | array       |
| output2.tymd | 현지영업일자   | String       | Y        | 8      |             |
| output2.xymd | 현지기준일자   | String       | Y        | 8      |             |
| output2.xhms | 현지기준시간   | String       | Y        | 6      |             |
| output2.kymd | 한국기준일자   | String       | Y        | 8      |             |
| output2.khms | 한국기준시간   | String       | Y        | 6      |             |
| output2.open | 시가           | String       | Y        | 12     |             |
| output2.high | 고가           | String       | Y        | 12     |             |
| output2.low  | 저가           | String       | Y        | 12     |             |
| output2.last | 종가           | String       | Y        | 12     |             |
| output2.evol | 체결량         | String       | Y        | 12     |             |
| output2.eamt | 체결대금       | String       | Y        | 14     |             |
