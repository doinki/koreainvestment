# [해외주식조건검색[v1\_해외주식-015]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/overseas-price/v1/quotations/inquire-search)
...
- 실전 TR ID: HHDFS76410000
- 모의 TR ID: HHDFS76410000
...
| output1.zdiv    | 소수점자리수   | String       | Y        | 1      | 소수점자리수                                                                                                                                                                                                    |
| output1.stat    | 거래상태정보   | String       | Y        | 20     | 거래상태정보                                                                                                                                                                                                    |
| output1.crec    | 현재조회종목수 | String       | Y        | 6      | 현재조회종목수                                                                                                                                                                                                  |
| output1.trec    | 전체조회종목수 | String       | Y        | 6      | 전체조회종목수                                                                                                                                                                                                  |
| output1.nrec    | Record Count   | String       | Y        | 4      | Record Count                                                                                                                                                                                                    |
| output2         | 응답상세2      | Object Array | Y        |        | 조회결과 상세                                                                                                                                                                                                   |
| output2.rsym    | 실시간조회심볼 | String       | N        | 32     | 실시간조회심볼 D+시장구분(3자리)+종목코드 예) DNASAAPL : D+NAS(나스닥)+AAPL(애플) [시장구분] NYS : 뉴욕, NAS : 나스닥, AMS : 아멕스 , TSE : 도쿄, HKS : 홍콩, SHS : 상해, SZS : 심천 HSX : 호치민, HNX : 하노이 |
| output2.excd    | 거래소코드     | String       | N        | 4      | 거래소코드                                                                                                                                                                                                      |
| output2.name    | 종목명         | String       | N        | 48     | 종목명                                                                                                                                                                                                          |
| output2.symb    | 종목코드       | String       | N        | 16     | 종목코드                                                                                                                                                                                                        |
| output2.last    | 현재가         | String       | N        | 12     | 현재가                                                                                                                                                                                                          |
| output2.shar    | 발행주식       | String       | N        | 14     | 발행주식수(단위: 천)                                                                                                                                                                                            |
| output2.valx    | 시가총액       | String       | N        | 14     | 시가총액(단위: 천)                                                                                                                                                                                              |
| output2.plow    | 저가           | String       | N        | 12     | 저가                                                                                                                                                                                                            |
| output2.phigh   | 고가           | String       | N        | 12     | 고가                                                                                                                                                                                                            |
| output2.popen   | 시가           | String       | N        | 12     | 시가                                                                                                                                                                                                            |
| output2.tvol    | 거래량         | String       | N        | 14     | 거래량(단위: 주)                                                                                                                                                                                                |
| output2.rate    | 등락율         | String       | N        | 12     | 등락율(%)                                                                                                                                                                                                       |
| output2.diff    | 대비           | String       | N        | 12     | 대비                                                                                                                                                                                                            |
| output2.sign    | 기호           | String       | N        | 1      | 기호                                                                                                                                                                                                            |
| output2.avol    | 거래대금       | String       | N        | 14     | 거래대금(단위: 천)                                                                                                                                                                                              |
| output2.eps     | EPS            | String       | N        | 14     | EPS                                                                                                                                                                                                             |
| output2.per     | PER            | String       | N        | 14     | PER                                                                                                                                                                                                             |
| output2.rank    | 순위           | String       | N        | 6      | 순위                                                                                                                                                                                                            |
| output2.ename   | 영문종목명     | String       | N        | 48     | 영문종목명                                                                                                                                                                                                      |
| output2.e_ordyn | 매매가능       | String       | N        | 2      | 가능 : O                                                                                                                                                                                                        |
