# [해외주식 기간별시세[v1\_해외주식-010]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/overseas-price/v1/quotations/dailyprice)
...
- 실전 TR ID: HHDFS76240000
- 모의 TR ID: HHDFS76240000
...
| output1.rsym | 실시간조회종목코드 | String       | Y        | 16     | D+시장구분(3자리)+종목코드 예) DNASAAPL : D+NAS(나스닥)+AAPL(애플) [시장구분] NYS : 뉴욕, NAS : 나스닥, AMS : 아멕스 , TSE : 도쿄, HKS : 홍콩, SHS : 상해, SZS : 심천 HSX : 호치민, HNX : 하노이 |
| output1.zdiv | 소수점자리수       | String       | Y        | 1      |                                                                                                                                                                                                  |
| output1.nrec | 전일종가           | String       | Y        | 12     |                                                                                                                                                                                                  |
| output2      | 응답상세2          | Object Array | Y        |        |                                                                                                                                                                                                  |
| output2.xymd | 일자(YYYYMMDD)     | String       | Y        | 8      |                                                                                                                                                                                                  |
| output2.clos | 종가               | String       | Y        | 12     | 해당 일자의 종가                                                                                                                                                                                 |
| output2.sign | 대비기호           | String       | Y        | 1      | 1 : 상한 2 : 상승 3 : 보합 4 : 하한 5 : 하락                                                                                                                                                     |
| output2.diff | 대비               | String       | Y        | 12     | 해당 일자의 종가와 해당 전일 종가의 차이 (해당일 종가-해당 전일 종가)                                                                                                                            |
| output2.rate | 등락율             | String       | Y        | 12     | 해당 전일 대비 / 해당일 종가 \* 100                                                                                                                                                              |
| output2.open | 시가               | String       | Y        | 12     | 해당일 최초 거래가격                                                                                                                                                                             |
| output2.high | 고가               | String       | Y        | 12     | 해당일 가장 높은 거래가격                                                                                                                                                                        |
| output2.low  | 저가               | String       | Y        | 12     | 해당일 가장 낮은 거래가격                                                                                                                                                                        |
| output2.tvol | 거래량             | String       | Y        | 14     | 해당일 거래량                                                                                                                                                                                    |
| output2.tamt | 거래대금           | String       | Y        | 14     | 해당일 거래대금                                                                                                                                                                                  |
| output2.pbid | 매수호가           | String       | Y        | 12     | 마지막 체결이 발생한 시점의 매수호가 \* 해당 일자 거래량 0인 경우 값이 수신되지 않음                                                                                                             |
| output2.vbid | 매수호가잔량       | String       | Y        | 10     | \* 해당 일자 거래량 0인 경우 값이 수신되지 않음                                                                                                                                                  |
| output2.pask | 매도호가           | String       | Y        | 12     | 마지막 체결이 발생한 시점의 매도호가 \* 해당 일자 거래량 0인 경우 값이 수신되지 않음                                                                                                             |
| output2.vask | 매도호가잔량       | String       | Y        | 10     | \* 해당 일자 거래량 0인 경우 값이 수신되지 않음                                                                                                                                                  |
