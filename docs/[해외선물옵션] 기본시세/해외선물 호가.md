# [해외선물 호가 [해외선물-031]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/overseas-futureoption/v1/quotations/inquire-asking-price)
...
| output1.lowp_rice       | 저가           | String       | Y        | 15     |             |
| output1.last_price      | 현재가         | String       | Y        | 15     |             |
| output1.prev_price      | 전일종가       | String       | Y        | 15     |             |
| output1.vol             | 거래량         | String       | Y        | 10     |             |
| output1.prev_diff_price | 전일대비가     | String       | Y        | 15     |             |
| output1.prev_diff_rate  | 전일대비율     | String       | Y        | 10     |             |
| output1.quot_date       | 호가수신일자   | String       | Y        | 8      |             |
| output1.quot_time       | 호가수신시각   | String       | Y        | 6      |             |
| output2                 | 응답상세       | Object Array | Y        |        | array       |
| output2.bid_qntt        | 매수수량       | String       | Y        | 10     |             |
| output2.bid_num         | 매수번호       | String       | Y        | 10     |             |
| output2.bid_price       | 매수호가       | String       | Y        | 15     |             |
| output2.ask_qntt        | 매도수량       | String       | Y        | 10     |             |
| output2.ask_num         | 매도번호       | String       | Y        | 10     |             |
| output2.ask_price       | 매도호가       | String       | Y        | 15     |             |
