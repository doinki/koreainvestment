# [해외옵션 체결추이(일간) [해외선물-037]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/overseas-futureoption/v1/quotations/opt-daily-ccnl)
...
| output1.ret_cnt         | 자료개수       | String       | Y        | 4      | ※ "input > QRY_CNT" +1 개 만큼 조회됨                                                                                                      |
| output1.last_n_cnt      | N틱최종개수    | String       | Y        | 4      |                                                                                                                                            |
| output1.index_key       | 이전조회KEY    | String       | Y        | 30     |                                                                                                                                            |
| output2                 | 응답상세       | Object Array | Y        |        | array                                                                                                                                      |
| output2.data_date       | 일자           | String       | Y        | 8      | 과거일자 ~ 최근일자 순으로 조회됨                                                                                                          |
| output2.data_time       | 시간           | String       | Y        | 6      | ""                                                                                                                                         |
| output2.open_price      | 시가           | String       | Y        | 15     |                                                                                                                                            |
| output2.high_price      | 고가           | String       | Y        | 15     |                                                                                                                                            |
| output2.low_price       | 저가           | String       | Y        | 15     |                                                                                                                                            |
| output2.last_price      | 체결가격       | String       | Y        | 15     | 체결가격 ※ focode.mst, fostkcode.mst* 의 sCalcDesz(계산 소수점) 값 참고 * 포럼 > FAQ > 종목정보 다운로드(해외) - 해외지수옵션/해외주식옵션 |
| output2.last_qntt       | 체결수량       | String       | Y        | 10     |                                                                                                                                            |
| output2.vol             | 누적거래수량   | String       | Y        | 10     |                                                                                                                                            |
| output2.prev_diff_flag  | 전일대비구분   | String       | Y        | 1      |                                                                                                                                            |
| output2.prev_diff_price | 전일대비가격   | String       | Y        | 15     |                                                                                                                                            |
| output2.prev_diff_rate  | 전일대비율     | String       | Y        | 10     |                                                                                                                                            |
