# [해외선물 미결제추이 [해외선물-029]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/overseas-futureoption/v1/quotations/investor-unpd-trend)
...
| output1.row_cnt          | 응답레코드카운트 | String       | Y        | 4      |             |
| output2                  | 응답상세         | Object Array | Y        |        | array       |
| output2.prod_iscd        | 상품             | String       | Y        | 5      |             |
| output2.cftc_iscd        | CFTC코드         | String       | Y        | 10     |             |
| output2.bsop_date        | 일자             | String       | Y        | 8      |             |
| output2.bidp_spec        | 매수투기         | String       | Y        | 10     |             |
| output2.askp_spec        | 매도투기         | String       | Y        | 10     |             |
| output2.spread_spec      | 스프레드투기     | String       | Y        | 10     |             |
| output2.bidp_hedge       | 매수헤지         | String       | Y        | 10     |             |
| output2.askp_hedge       | 매도헤지         | String       | Y        | 10     |             |
| output2.hts_otst_smtn    | 미결제합계       | String       | Y        | 10     |             |
| output2.bidp_missing     | 매수누락         | String       | Y        | 10     |             |
| output2.askp_missing     | 매도누락         | String       | Y        | 10     |             |
| output2.bidp_spec_cust   | 매수투기고객     | String       | Y        | 10     |             |
| output2.askp_spec_cust   | 매도투기고객     | String       | Y        | 10     |             |
| output2.spread_spec_cust | 스프레드투기고객 | String       | Y        | 10     |             |
| output2.bidp_hedge_cust  | 매수헤지고객     | String       | Y        | 10     |             |
| output2.askp_hedge_cust  | 매도헤지고객     | String       | Y        | 10     |             |
| output2.cust_smtn        | 고객합계         | String       | Y        | 10     |             |
