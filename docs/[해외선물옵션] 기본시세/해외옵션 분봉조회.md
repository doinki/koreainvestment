# [해외옵션 분봉조회 [해외선물-040]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/overseas-futureoption/v1/quotations/inquire-time-optchartprice)
...
| output2.ret_cnt         | 자료개수       | String       | Y        | 4      |                                                                                                                                            |
| output2.last_n_cnt      | N틱최종개수    | String       | Y        | 4      |                                                                                                                                            |
| output2.index_key       | 이전조회KEY    | String       | Y        | 30     |                                                                                                                                            |
| output1                 | 응답상세       | Object Array | Y        |        | array                                                                                                                                      |
| output1.data_date       | 일자           | String       | Y        | 8      |                                                                                                                                            |
| output1.data_time       | 시간           | String       | Y        | 6      |                                                                                                                                            |
| output1.open_price      | 시가           | String       | Y        | 15     |                                                                                                                                            |
| output1.high_price      | 고가           | String       | Y        | 15     |                                                                                                                                            |
| output1.low_price       | 저가           | String       | Y        | 15     |                                                                                                                                            |
| output1.last_price      | 체결가격       | String       | Y        | 15     | 체결가격 ※ focode.mst, fostkcode.mst* 의 sCalcDesz(계산 소수점) 값 참고 * 포럼 > FAQ > 종목정보 다운로드(해외) - 해외지수옵션/해외주식옵션 |
| output1.last_qntt       | 체결수량       | String       | Y        | 10     |                                                                                                                                            |
