# [해외옵션 상품기본정보 [해외선물-041]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/overseas-futureoption/v1/quotations/search-opt-detail)
...
| output2.exch_cd         | 거래소코드     | String       | Y        | 10     |                                                                                                                                          |
| output2.clas_cd         | 품목종류       | String       | Y        | 1      |                                                                                                                                          |
| output2.crc_cd          | 거래통화       | String       | Y        | 10     |                                                                                                                                          |
| output2.sttl_price      | 정산가         | String       | Y        | 15     | 정산가 ※ focode.mst, fostkcode.mst* 의 sCalcDesz(계산 소수점) 값 참고 * 포럼 > FAQ > 종목정보 다운로드(해외) - 해외지수옵션/해외주식옵션 |
| output2.sttl_date       | 정산일         | String       | Y        | 8      |                                                                                                                                          |
| output2.trst_mgn        | 증거금         | String       | Y        | 19     |                                                                                                                                          |
| output2.disp_digit      | 가격표시진법   | String       | Y        | 10     |                                                                                                                                          |
| output2.tick_sz         | 틱사이즈       | String       | Y        | 19     |                                                                                                                                          |
| output2.tick_val        | 틱가치         | String       | Y        | 19     |                                                                                                                                          |
| output2.mrkt_open_date  | 장개시일자     | String       | Y        | 8      |                                                                                                                                          |
| output2.mrkt_open_time  | 장개시시각     | String       | Y        | 6      |                                                                                                                                          |
| output2.mrkt_close_date | 장마감일자     | String       | Y        | 8      |                                                                                                                                          |
| output2.mrkt_close_time | 장마감시각     | String       | Y        | 6      |                                                                                                                                          |
| output2.trd_fr_date     | 상장일         | String       | Y        | 8      |                                                                                                                                          |
| output2.expr_date       | 만기일         | String       | Y        | 8      |                                                                                                                                          |
| output2.trd_to_date     | 최종거래일     | String       | Y        | 8      |                                                                                                                                          |
| output2.remn_cnt        | 잔존일수       | String       | Y        | 4      |                                                                                                                                          |
| output2.stat_tp         | 매매여부       | String       | Y        | 1      |                                                                                                                                          |
| output2.ctrt_size       | 계약크기       | String       | Y        | 19     |                                                                                                                                          |
| output2.stl_tp          | 최종결제구분   | String       | Y        | 20     |                                                                                                                                          |
| output2.frst_noti_date  | 최초식별일     | String       | Y        | 8      |                                                                                                                                          |
