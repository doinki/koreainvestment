# [해외옵션 체결추이(틱) [해외선물-038]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/overseas-futureoption/v1/quotations/opt-tick-ccnl)
...
| output1.ret_cnt         | 자료개수       | String       | Y        | 4      |                                                                                                                                            |
...
| output2.data_time       | 시간           | String       | Y        | 6      | HHMMSS                                                                                                                                     |
