# [해외주식 미국주간주문[v1\_해외주식-026]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/overseas-stock/v1/trading/daytime-order)
...
- 모의 DOMAIN: 모의투자 미지원
- 실전 TR ID: (주간매수) TTTS6036U (주간매도) TTTS6037U
- 모의 TR ID: 모의투자 미지원
