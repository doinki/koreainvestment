# [해외주식 지정가주문번호조회 [해외주식-071]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/overseas-stock/v1/trading/algo-ordno)
...
| output.ft_ord_qty         | FT주문수량          | String       | Y        | 4      |                             |
| output.ft_ord_unpr3       | FT주문단가          | String       | Y        | 8      |                             |
| output.splt_buy_attr_name | 분할매수속성명      | String       | Y        | 60     |                             |
| output.ft_ccld_qty        | FT체결수량          | String       | Y        | 4      |                             |
