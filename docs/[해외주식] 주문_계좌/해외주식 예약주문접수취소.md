# [해외주식 예약주문접수취소[v1\_해외주식-004]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/overseas-stock/v1/trading/order-resv-ccnl)
...
- 실전 TR ID: (미국 예약주문 취소접수) TTTT3017U (아시아국가 미제공)
- 모의 TR ID: (미국 예약주문 취소접수) VTTT3017U (아시아국가 미제공)
...
| OVRS_RSVN_ODNO   | 해외예약주문번호 | String | Y        | 10     | 해외주식\_예약주문접수 API Output ODNO(주문번호) 참고 |
...
| output.OVRS_RSVN_ODNO | 해외예약주문번호 | String | Y        | 10     |                             |
