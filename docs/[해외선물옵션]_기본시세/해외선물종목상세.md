# [해외선물종목상세 [v1\_해외선물-008]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/overseas-futureoption/v1/quotations/stock-detail)
...
| output1.tick_sz         | 틱사이즈         | String | N        | 19     | 틱사이즈                                                                        |
| output1.disp_digit      | 가격표시진법     | String | N        | 10     | 가격표시진법                                                                    |
| output1.trst_mgn        | 증거금           | String | N        | 19     | 증거금                                                                          |
| output1.sttl_date       | 정산일           | String | N        | 8      | 정산일                                                                          |
...
| output1.clas_cd         | 품목종류         | String | N        | 3      | 품목종류                                                                        |
| output1.tick_val        | 틱가치           | String | N        | 19     | 틱가치                                                                          |
| output1.mrkt_open_date  | 장개시일자       | String | N        | 8      | 장개시일자                                                                      |
| output1.mrkt_open_time  | 장개시시각       | String | N        | 6      | 장개시시각                                                                      |
| output1.mrkt_close_date | 장마감일자       | String | N        | 8      | 장마감일자                                                                      |
| output1.mrkt_close_time | 장마감시각       | String | N        | 6      | 장마감시각                                                                      |
...
| output1.stat_tp         | 매매여부         | String | N        | 1      | 매매여부                                                                        |
| output1.ctrt_size       | 계약크기         | String | N        | 19     | 계약크기                                                                        |
| output1.stl_tp          | 최종결제구분     | String | N        | 20     | 최종결제구분                                                                    |
| output1.frst_noti_date  | 최초식별일       | String | N        | 8      | 최초식별일                                                                      |
| output1.sprd_srs_cd1    | 스프레드 종목 #1 | String | N        | 32     |                                                                                 |
| output1.sprd_srs_cd2    | 스프레드 종목 #2 | String | N        | 32     |                                                                                 |
