# [해외선물 체결추이(월간)[해외선물-020]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/overseas-futureoption/v1/quotations/monthly-ccnl)
...
| output2.last_price      | 체결가격       | String       | Y        | 15     |             |
