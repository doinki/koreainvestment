# [해외선물 분봉조회[해외선물-016]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/overseas-futureoption/v1/quotations/inquire-time-futurechartprice)
...
| output1.data_time       | 시각           | String       | Y        | 6      |                                                                                 |
| output1.open_price      | 시가           | String       | Y        | 15     |                                                                                 |
| output1.high_price      | 고가           | String       | Y        | 15     |                                                                                 |
| output1.low_price       | 저가           | String       | Y        | 15     |                                                                                 |
| output1.last_price      | 체결가격       | String       | Y        | 15     | 체결가격 ※ ffcode.mst(해외선물종목마스터 파일)의 sCalcDesz(계산 소수점) 값 참고 |
