# [장내채권 잔고조회 [국내주식-198]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-bond/v1/trading/inquire-balance)
...
| output.buy_dt       | 매수일자       | String       | Y        | 8      |             |
| output.buy_sqno     | 매수일련번호   | String       | Y        | 10     |             |
| output.cblc_qty     | 잔고수량       | String       | Y        | 19     |             |
| output.agrx_qty     | 종합과세수량   | String       | Y        | 10     |             |
| output.sprx_qty     | 분리과세수량   | String       | Y        | 10     |             |
| output.exdt         | 만기일         | String       | Y        | 8      |             |
| output.buy_erng_rt  | 매수수익율     | String       | Y        | 238    |             |
| output.buy_unpr     | 매수단가       | String       | Y        | 19     |             |
| output.buy_amt      | 매수금액       | String       | Y        | 19     |             |
