# [국내주식 시가총액 상위[v1\_국내주식-091]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/ranking/market-cap)
...
| output.stck_avls           | 시가 총액               | String       | Y        | 18     |             |
| output.mrkt_whol_avls_rlim | 시장 전체 시가총액 비중 | String       | Y        | 52     |             |
