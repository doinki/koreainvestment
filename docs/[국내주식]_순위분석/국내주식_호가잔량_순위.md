# [국내주식 호가잔량 순위[국내주식-089]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/ranking/quote-balance)
...
| output.total_ntsl_bidp_rsqn | 총 순 매수호가 잔량    | String       | Y        | 12     |             |
| output.shnu_rsqn_rate       | 매수 잔량 비율         | String       | Y        | 84     |             |
