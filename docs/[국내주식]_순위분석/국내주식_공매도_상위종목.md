# [국내주식 공매도 상위종목[국내주식-133]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/ranking/short-sale)
...
| output.ssts_cntg_qty     | 공매도 체결 수량       | String       | Y        | 12     |             |
| output.ssts_vol_rlim     | 공매도 거래량 비중     | String       | Y        | 62     |             |
| output.ssts_tr_pbmn      | 공매도 거래 대금       | String       | Y        | 18     |             |
| output.ssts_tr_pbmn_rlim | 공매도 거래대금 비중   | String       | Y        | 62     |             |
| output.stnd_date1        | 기준 일자1             | String       | Y        | 8      |             |
| output.stnd_date2        | 기준 일자2             | String       | Y        | 8      |             |
| output.avrg_prc          | 평균가격               | String       | Y        | 11     |             |
