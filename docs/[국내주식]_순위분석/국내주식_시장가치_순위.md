# [국내주식 시장가치 순위[v1\_국내주식-096]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/ranking/market-value)
...
| output.pcr                  | PCR                    | String       | Y        | 82     |             |
| output.psr                  | PSR                    | String       | Y        | 82     |             |
| output.eps                  | EPS                    | String       | Y        | 112    |             |
| output.eva                  | EVA                    | String       | Y        | 82     |             |
| output.ebitda               | EBITDA                 | String       | Y        | 82     |             |
| output.pv_div_ebitda        | PV DIV EBITDA          | String       | Y        | 82     |             |
| output.ebitda_div_fnnc_expn | EBITDA DIV 금융비용    | String       | Y        | 82     |             |
