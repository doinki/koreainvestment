# [국내주식 신용잔고 상위[국내주식-109]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/ranking/credit-balance)
...
| output1.stnd_date1               | 기준 일자1                | String       | Y        | 8      |             |
| output1.stnd_date2               | 기준 일자2                | String       | Y        | 8      |             |
...
| output2.whol_loan_rmnd_stcn      | 전체 융자 잔고 주수       | String       | Y        | 18     |             |
| output2.whol_loan_rmnd_amt       | 전체 융자 잔고 금액       | String       | Y        | 18     |             |
| output2.whol_loan_rmnd_rate      | 전체 융자 잔고 비율       | String       | Y        | 84     |             |
| output2.whol_stln_rmnd_stcn      | 전체 대주 잔고 주수       | String       | Y        | 18     |             |
| output2.whol_stln_rmnd_amt       | 전체 대주 잔고 금액       | String       | Y        | 18     |             |
| output2.whol_stln_rmnd_rate      | 전체 대주 잔고 비율       | String       | Y        | 84     |             |
| output2.nday_vrss_loan_rmnd_inrt | N일 대비 융자 잔고 증가율 | String       | Y        | 84     |             |
| output2.nday_vrss_stln_rmnd_inrt | N일 대비 대주 잔고 증가율 | String       | Y        | 84     |             |
