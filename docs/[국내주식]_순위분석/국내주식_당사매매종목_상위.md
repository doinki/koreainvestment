# [국내주식 당사매매종목 상위[v1\_국내주식-104]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/ranking/traded-by-company)
...
| output.seln_cnqn_smtn | 매도 체결량 합계       | String       | Y        | 18     |             |
| output.shnu_cnqn_smtn | 매수2 체결량 합계      | String       | Y        | 18     |             |
| output.ntby_cnqn      | 순매수 체결량          | String       | Y        | 18     |             |
