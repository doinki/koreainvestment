# [국내주식 신고/신저근접종목 상위[v1\_국내주식-105]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/ranking/near-new-highlow)
...
| output.new_hgpr       | 신 최고가              | String       | Y        | 10     |             |
| output.hprc_near_rate | 고가 근접 비율         | String       | Y        | 84     |             |
| output.new_lwpr       | 신 최저가              | String       | Y        | 10     |             |
| output.lwpr_near_rate | 저가 근접 비율         | String       | Y        | 84     |             |
