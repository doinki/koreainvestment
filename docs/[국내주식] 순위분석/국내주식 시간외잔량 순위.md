# [국내주식 시간외잔량 순위[v1\_국내주식-093]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/ranking/after-hour-balance)
...
| output.ovtm_total_askp_rsqn | 시간외 총 매도호가 잔량    | String       | Y        | 12     |             |
| output.ovtm_total_bidp_rsqn | 시간외 총 매수호가 잔량    | String       | Y        | 12     |             |
| output.mkob_otcp_vol        | 장개시전 시간외종가 거래량 | String       | Y        | 18     |             |
| output.mkfa_otcp_vol        | 장종료후 시간외종가 거래량 | String       | Y        | 18     |             |
