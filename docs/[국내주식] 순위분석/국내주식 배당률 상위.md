# [국내주식 배당률 상위[국내주식-106]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/ranking/dividend-rate)
...
| output1.rank             | 순위               | String       | Y        | 4      |             |
| output1.sht_cd           | 종목코드           | String       | Y        | 9      |             |
| output1.isin_name        | 종목명             | String       | Y        | 40     |             |
| output1.record_date      | 기준일             | String       | Y        | 8      |             |
| output1.per_sto_divi_amt | 현금/주식배당금    | String       | Y        | 12     |             |
| output1.divi_rate        | 현금/주식배당률(%) | String       | Y        | 62     |             |
