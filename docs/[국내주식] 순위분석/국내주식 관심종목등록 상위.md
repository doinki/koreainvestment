# [국내주식 관심종목등록 상위[v1\_국내주식-102]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/ranking/top-interest-stock)
...
| output.mrkt_div_cls_name   | 시장 분류 구분 명      | String       | Y        | 40     |             |
...
| output.inter_issu_reg_csnu | 관심 종목 등록 건수    | String       | Y        | 10     |             |
