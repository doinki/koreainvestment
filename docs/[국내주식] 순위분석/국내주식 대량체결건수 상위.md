# [국내주식 대량체결건수 상위[국내주식-107]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/ranking/bulk-trans-num)
...
| output.shnu_cntg_csnu | 매수2 체결 건수        | String       | Y        | 10     |             |
| output.seln_cntg_csnu | 매도 체결 건수         | String       | Y        | 10     |             |
