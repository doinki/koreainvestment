# [장내채권 정정취소주문 [국내주식-125]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-bond/v1/trading/order-rvsecncl)
...
| output.krx_fwdg_ord_orgno | 한국거래소전송주문조직번호 | String | Y        | 5      |             |
