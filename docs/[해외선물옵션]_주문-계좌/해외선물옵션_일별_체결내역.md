# [해외선물옵션 일별 체결내역[해외선물-011]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/overseas-futureoption/v1/trading/inquire-daily-ccld)
...
| output2.fm_tot_ccld_qty       | FM총체결수량       | String       | Y        | 10     |                                      |
| output2.fm_tot_futr_agrm_amt  | FM총선물약정금액   | String       | Y        | 20     |                                      |
| output2.fm_tot_opt_agrm_amt   | FM총옵션약정금액   | String       | Y        | 20     |                                      |
| output2.fm_fee_smtl           | FM수수료합계       | String       | Y        | 20     |                                      |
| output1                       | 응답상세1          | Object Array | Y        |        | Array                                |
| output1.dt                    | 일자               | String       | Y        | 8      |                                      |
| output1.ccno                  | 체결번호           | String       | Y        | 8      |                                      |
| output1.ovrs_futr_fx_pdno     | 해외선물FX상품번호 | String       | Y        | 32     |                                      |
| output1.sll_buy_dvsn_cd       | 매도매수구분코드   | String       | Y        | 3      |                                      |
| output1.fm_ccld_qty           | FM체결수량         | String       | Y        | 10     |                                      |
| output1.fm_ccld_amt           | FM체결금액         | String       | Y        | 20     |                                      |
| output1.fm_futr_ccld_amt      | FM선물체결금액     | String       | Y        | 20     |                                      |
| output1.fm_opt_ccld_amt       | FM옵션체결금액     | String       | Y        | 20     |                                      |
| output1.crcy_cd               | 통화코드           | String       | Y        | 3      |                                      |
| output1.fm_fee                | FM수수료           | String       | Y        | 20     |                                      |
| output1.fm_futr_pure_agrm_amt | FM선물순약정금액   | String       | Y        | 20     |                                      |
| output1.fm_opt_pure_agrm_amt  | FM옵션순약정금액   | String       | Y        | 20     |                                      |
| output1.ccld_dtl_dtime        | 체결상세일시       | String       | Y        | 17     |                                      |
| output1.ord_dt                | 주문일자           | String       | Y        | 8      |                                      |
| output1.odno                  | 주문번호           | String       | Y        | 8      | 접수한 주문의 일련번호(ex. 00360686) |
| output1.ord_mdia_dvsn_name    | 주문매체구분명     | String       | Y        | 60     |                                      |
