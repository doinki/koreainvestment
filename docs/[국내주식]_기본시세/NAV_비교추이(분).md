# [NAV 비교추이(분)[v1\_국내주식-070]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/etfetn/v1/quotations/nav-comparison-time-trend)
...
| output.bsop_hour          | 영업 시간          | String       | Y        | 6      |             |
