# [주식현재가 일자별[v1\_국내주식-010]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/quotations/inquire-daily-price)
...
- 실전 TR ID: FHKST01010400
- 모의 TR ID: FHKST01010400
...
| output.prdy_vrss_vol_rate | 전일 대비 거래량 비율 | String       | Y        | 84     | 13(8.4)                                                                                                         |
| output.prdy_vrss          | 전일 대비             | String       | Y        | 10     |                                                                                                                 |
| output.prdy_vrss_sign     | 전일 대비 부호        | String       | Y        | 1      |                                                                                                                 |
| output.prdy_ctrt          | 전일 대비율           | String       | Y        | 82     | 11(8.2)                                                                                                         |
| output.hts_frgn_ehrt      | HTS 외국인 소진율     | String       | Y        | 82     | 11(8.2)                                                                                                         |
| output.frgn_ntby_qty      | 외국인 순매수 수량    | String       | Y        | 12     |                                                                                                                 |
| output.flng_cls_code      | 락 구분 코드          | String       | Y        | 2      | '01 : 권리락 02 : 배당락 03 : 분배락 04 : 권배락 05 : 중간(분기)배당락 06 : 권리중간배당락 07 : 권리분기배당락' |
| output.acml_prtt_rate     | 누적 분할 비율        | String       | Y        | 84     | 13(8.4)                                                                                                         |
