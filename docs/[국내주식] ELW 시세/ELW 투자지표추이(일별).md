# [ELW 투자지표추이(일별) [국내주식-173]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/elw/v1/quotations/indicator-trend-daily)
...
| output.apprch_rate    | 접근도         | String       | Y        | 112    |             |
