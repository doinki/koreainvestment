# [장내채권현재가(체결) [국내주식-201]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-bond/v1/quotations/inquire-ccnl)
...
| output.bond_prpr      | 채권 현재가    | String | Y        | 112    |             |
| output.bond_prdy_vrss | 채권 전일 대비 | String | Y        | 112    |             |
