# [국내주식 증권사별 투자의견 [국내주식-189]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/quotations/invest-opbysec)
...
| output.stck_shrn_iscd          | 주식단축종목코드     | String       | Y        | 9      |             |
| output.hts_kor_isnm            | HTS한글종목명        | String       | Y        | 40     |             |
| output.invt_opnn               | 투자의견             | String       | Y        | 40     |             |
| output.invt_opnn_cls_code      | 투자의견구분코드     | String       | Y        | 2      |             |
| output.rgbf_invt_opnn          | 직전투자의견         | String       | Y        | 40     |             |
| output.rgbf_invt_opnn_cls_code | 직전투자의견구분코드 | String       | Y        | 2      |             |
| output.mbcr_name               | 회원사명             | String       | Y        | 50     |             |
| output.stck_prpr               | 주식현재가           | String       | Y        | 10     |             |
| output.prdy_vrss               | 전일대비             | String       | Y        | 10     |             |
| output.prdy_vrss_sign          | 전일대비부호         | String       | Y        | 1      |             |
| output.prdy_ctrt               | 전일대비율           | String       | Y        | 82     |             |
| output.hts_goal_prc            | HTS목표가격          | String       | Y        | 10     |             |
| output.stck_prdy_clpr          | 주식전일종가         | String       | Y        | 10     |             |
| output.stft_esdg               | 주식선물괴리도       | String       | Y        | 10     |             |
