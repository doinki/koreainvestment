# [국내주식 종목투자의견 [국내주식-188]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/domestic-stock/v1/quotations/invest-opinion)
...
| output.stck_nday_esdg          | 주식N일괴리도        | String       | Y        | 10     |             |
| output.nday_dprt               | N일괴리율            | String       | Y        | 82     |             |
