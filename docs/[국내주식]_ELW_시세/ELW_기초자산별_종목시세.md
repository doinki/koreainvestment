# [ELW 기초자산별 종목시세 [국내주식-186]](https://apiportal.koreainvestment.com/apiservice-apiservice?/uapi/elw/v1/quotations/udrl-asset-price)
...
| output.lp_hvol            | LP보유량         | String       | Y        | 18     |             |
| output.lp_rlim            | LP비중           | String       | Y        | 52     |             |
